        ...
        >
          ...
          >
            ...
            <p className="text-[13px] font-400 leading-relaxed mt-2 mb-5" style={{ color: '#A39B98' }}>
              {playerCount > 0
                ? `Сейчас в составе ${playersLabel}. Места, очки, нокауты и комментарии по турниру в копию не переносятся.`
                : 'Состав пустой. Можно скопировать только настройки турнира. Комментарии по турниру в копии будут пустыми.'}
            </p>
