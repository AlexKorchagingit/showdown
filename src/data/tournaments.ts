...
export const MOCK_TOURNAMENTS: Tournament[] = [
  {
    ...
    blindStructureId: 'bs-grand-opening',
    stackSize: 30000,
  ...
  },
  {
    ...
    participants: (() => {
      ...
      return list.map((p, index) => {
        // Places 1–9 (final table) plus 16–20; 10–15 stay empty so the missing-places warning shows.
        const placed =
          index < 9 || index >= 15
            ? applyPlaceToParticipant(p, index + 1, 10000, list.length)
            : p;
  ...
  },
  {
    ...
    blindStructureId: 'bs-bounty-hunter',
    stackSize: 30000,
    levelDuration: '20/15 мин',
    isClosed: true,
    isBounty: true,
