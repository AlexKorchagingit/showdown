...
begin
  ...
  if has_table_privilege('authenticated','public.user_achievements','SELECT')
    or has_table_privilege('authenticated','public.user_achievements','INSERT')
    or has_table_privilege('authenticated','public.user_achievements','UPDATE')
    or has_table_privilege('authenticated','public.user_achievements','DELETE')
